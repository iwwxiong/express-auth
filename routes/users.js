...
router.get('/user/:userId/permission/:permissionId', User.getUserPermission);
...
router.get('/user/:userId/group/:groupId', User.getUserGroup);
router.get('/group/:groupId/permissions', User.getGroupPermissions);
router.get('/group/:groupId/permission/:permissionId', User.getGroupPermission);
